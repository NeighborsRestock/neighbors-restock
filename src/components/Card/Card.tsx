...
export const Card = ({ title, bodyText }: CardInfoProps) => {
  ...
  return (
    <button
      ...
      className={`w-[30%] tablet:mb-[10px] tablet:w-full group shadow-none focus:outline-blue-500 focus:border-none transition duration-400 ease-in-out overflow-hidden relative mr-[15px] max-h-[1000px] py-[35px] px-[30px] h-auto bg-slate-200 text-left`}
    >
