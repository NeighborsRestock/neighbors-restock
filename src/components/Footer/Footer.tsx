...
export const Footer = () => {
  return (
    <footer className="[&>*:not(:nth-last-child(-n+2))]:mb-[30px] w-screen h-[80vh] px-[25px] pt-[90px] bg-[#0e1b23] relative items-self-end flex flex-col items-center justify-start overflow-hidden">
